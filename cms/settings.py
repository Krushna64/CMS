...
SECRET_KEY = 'django-insecure-7e^$-pr*#@_x-82r5ozd3rg1+!&tzdyinbwb!gp66@9%14tz#9'
...
# Don't append '/' at the end of url if not found
# https://docs.djangoproject.com/en/3.2/ref/settings/#append-slash
APPEND_SLASH = False


# Creates static and media directory if it does not exists
